<script lang="ts">
	...
	type Props = {
		/** Reactive draft — fields are mutated in place. */
		invoice: InvoiceData;
...
<section class="border-border bg-card rounded-lg border p-4 sm:p-6">
	<h2 class="text-foreground mb-4 text-base font-semibold">{t('section.payment')}</h2>
